...
export const learningCategories: LearningCategory[] = [
  ...
  { id: "resources", title: "源项目与论文", icon: "RP", description: "TradingAgents项目介绍和学术论文资源" },
...
export const learningArticles: LearningArticle[] = [
  ...
  { id: "multi-agent-system", title: "多智能体系统详解", category: "analysis-principles", categoryTitle: "AI分析股票原理", description: "深入理解TradingAgents-CN的多智能体协作机制", readTime: "15分钟", difficulty: "进阶", views: 1654, file: "docs/learning/04-analysis-principles/multi-agent-system.md" },
  ...
  { id: "trading_agents_intro", title: "TradingAgents项目介绍", category: "resources", categoryTitle: "源项目与论文", description: "了解TradingAgents源项目的架构和特性", readTime: "15分钟", difficulty: "进阶", views: 1432, file: "docs/learning/06-resources/trading_agents_intro.md" },
  { id: "paper-guide", title: "TradingAgents论文解读", category: "resources", categoryTitle: "源项目与论文", description: "深度解读TradingAgents学术论文的核心内容和创新点", readTime: "20分钟", difficulty: "高级", views: 987, file: "docs/learning/06-resources/paper-guide.md" },
  { id: "TradingAgents_论文中文版", title: "TradingAgents 论文中文版", category: "resources", categoryTitle: "源项目与论文", description: "TradingAgents 学术论文中文翻译", readTime: "40分钟", difficulty: "高级", views: 860, file: "docs/paper/TradingAgents_论文中文版.md" },
  { id: "getting-started", title: "快速入门教程", category: "tutorials", categoryTitle: "实战教程", description: "从零开始学习如何使用TradingAgents-CN进行股票分析", readTime: "10分钟", difficulty: "入门", views: 3456, externalUrl: "https://mp.weixin.qq.com/s/uAk4RevdJHMuMvlqpdGUEw" },
  { id: "usage-guide-preview", title: "使用指南（试用版）", category: "tutorials", categoryTitle: "实战教程", description: "TradingAgents-CN 使用指南与试用说明", readTime: "15分钟", difficulty: "入门", views: 1288, externalUrl: "https://mp.weixin.qq.com/s/ppsYiBncynxlsfKFG8uEbw" },
