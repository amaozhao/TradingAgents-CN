...
from app.models.stockmodels import (
...
class StockDataService:
    ...
    async def _get_stock_basic_info_from_postgres(
        ...
        try:
            ...
            from app.db.stockrepository import get_stock_basic_info
    ...
    async def _get_market_quotes_from_postgres(self, symbol: str) -> Optional[Dict[str, Any]]:
        try:
            from app.db.session import get_session_factory
            from app.db.stockrepository import get_market_quote
    ...
    async def _get_stock_list_from_postgres(
        ...
        *,
        ...
        try:
            from app.db.session import get_session_factory
            from app.db.stockrepository import list_stocks
