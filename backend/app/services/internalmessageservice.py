...
class InternalMessageService:
    ...
    async def _query_internal_messages_from_postgres(
        ...
        try:
            from app.db.messagerepository import query_internal_messages
    ...
    async def _search_messages_from_postgres(
        ...
        *,
        ...
        try:
            from app.db.messagerepository import search_internal_messages
            from app.db.session import get_session_factory
    ...
    async def _get_internal_statistics_from_postgres(
        ...
        *,
        ...
        try:
            from app.db.messagerepository import get_internal_message_stats
            from app.db.session import get_session_factory
