...
# 复用现有数据源提供者
from tradingagents.dataflows.providers.hk.hkstock import HKStockProvider
...
class ForeignStockService:
    ...
    def _get_hk_quote_from_akshare(self, code: str) -> Dict:
        """从AKShare获取港股行情"""
        from tradingagents.dataflows.providers.hk.improvedhk import get_hk_stock_info_akshare
    ...
    def _get_hk_info_from_akshare(self, code: str) -> Dict:
        ...
        from tradingagents.dataflows.providers.hk.improvedhk import (
    ...
    def _get_hk_kline_from_akshare(self, code: str, period: str, limit: int) -> List[Dict]:
        ...
        import pandas as pd
        from datetime import datetime, timedelta
        from tradingagents.dataflows.providers.hk.improvedhk import get_improved_hk_provider
