...
from app.core.coredatabase import get_database
...
class SocialMediaService:
    ...
    async def _query_social_media_messages_from_postgres(
        ...
        try:
            from app.db.messagerepository import query_social_media_messages
    ...
    async def _search_messages_from_postgres(
        ...
        *,
        ...
        try:
            from app.db.messagerepository import search_social_media_messages
            from app.db.session import get_session_factory
    ...
    async def _get_social_media_statistics_from_postgres(
        ...
        *,
        ...
        try:
            from app.db.messagerepository import get_social_media_stats
            from app.db.session import get_session_factory
