...
from tradingagents.llmclients.providerkeys import canonical_aliases, normalize_provider_key
...
class ConfigService:
    ...
    async def init_aggregator_providers(self) -> Dict[str, Any]:
        ...
        Returns:
            初始化结果统计
        """
        from app.constants.modelcapabilitiescatalog import AGGREGATOR_PROVIDERS
