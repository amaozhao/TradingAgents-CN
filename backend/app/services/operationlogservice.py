...
from app.models.operationlog import (
    OperationLogCreate,
...
class OperationLogService:
    ...
    async def _get_logs_from_postgres(self, query: OperationLogQuery) -> Optional[Tuple[List[OperationLogResponse], int]]:
        try:
            from app.db.operationlogrepository import list_operation_logs
    ...
    async def _get_stats_from_postgres(self, days: int) -> Optional[OperationLogStats]:
        try:
            from app.db.operationlogrepository import get_operation_log_stats
            from app.db.session import get_session_factory
