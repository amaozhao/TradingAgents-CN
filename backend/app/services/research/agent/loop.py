...
def build_research_prompt(
    *, principal: ResearchPrincipal, tools: list[ResearchTool]
    ...
    return (
        ...
        "the original single-stock LangGraph DAG remains only a baseline for comparison. "
        "Do not submit the DAG queue for new Agent single-stock requests. "
        "single_stock_analysis runs the migrated Agent-native workflow directly and writes "
        "a report compatible with the existing report pages. If the user asks for an "
