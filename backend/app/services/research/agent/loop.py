...
def build_research_prompt(
    *, principal: ResearchPrincipal, tools: list[ResearchTool]
    ...
    return (
        ...
        "analysis queue; it is not the final report. After submitting, use "
        "stock_analysis_status to inspect progress and stock_analysis_report only after "
        "the task is completed or when the user asks for an existing completed task.\n"
