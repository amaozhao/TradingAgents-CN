...
async def get_tushare_sync_service():
    from app.worker.tusharesyncservice import get_tushare_sync_service as _get_tushare_sync_service

    return await _get_tushare_sync_service()


async def get_akshare_sync_service():
    from app.worker.aksharesyncservice import get_akshare_sync_service as _get_akshare_sync_service

    return await _get_akshare_sync_service()


async def get_financial_sync_service():
    from app.worker.financialdatasyncservice import get_financial_sync_service as _get_financial_sync_service
    ...
    try:
        ...
        if request.sync_historical:
            try:
                ...
                #     from app.utils.tradingtime import is_trading_time
                #     if is_trading_time():
        ...
        if request.sync_basic:
            try:
                ...
                if request.data_source == "tushare":
                    from app.services.basicssync import (
