...
class AnalysisResultDocument(JsonbLegacyMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("legacy_id", name="uq_analysis_results_legacy_id"),
        Index("ix_analysis_results_task_user_created", "task_id", "user_id", "created_at"),
    )
...
class OperationLogDocument(JsonbLegacyMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("legacy_id", name="uq_operation_logs_legacy_id"),
        Index("ix_operation_logs_user_timestamp", "user_id", "timestamp"),
        Index("ix_operation_logs_action_success", "action_type", "success"),
    )
