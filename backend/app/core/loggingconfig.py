...
from app.core.loggingcontext import LoggingContextFilter, trace_id_var
...
def setup_logging(log_level: str = "INFO"):
    ...
    try:
        ...
        if cfg_path.exists() and toml_loader is not None:
            ...
            logging_config = {
                ...
                "filters": {
                    "request_context": {"()": "app.core.loggingcontext.LoggingContextFilter"}
                },
                "formatters": {
                    "console_fmt": {
                        "format": fmt_console,
                    ...
                    "json_console_fmt": {
                        "()": "app.core.loggingconfig.SimpleJsonFormatter"
                    },
                    "json_file_fmt": {
                        "()": "app.core.loggingconfig.SimpleJsonFormatter"
                    },
    ...
    logging_config = {
        "version": 1,
        "disable_existing_loggers": False,
        "filters": {"request_context": {"()": "app.core.loggingcontext.LoggingContextFilter"}},
        "formatters": {
            "default": {
