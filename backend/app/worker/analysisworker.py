...
from app.services.queueservice import get_queue_service
...
from app.core.redisclient import init_redis, close_redis
from app.core.coreconfig import settings
from app.models.analysismodels import AnalysisTask, AnalysisParameters
...
class AnalysisWorker:
    ...
    async def _send_heartbeat(self):
        """发送心跳"""
        try:
            from app.core.redisclient import get_redis_service
