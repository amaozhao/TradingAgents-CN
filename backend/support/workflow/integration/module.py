...
def test_news_analyst_integration():
    ...
    try:
        ...
        # 读取新闻分析师源码
        news_analyst_file = "backend/trader/agents/analysts/newsanalyst.py"
        try:
            ...
            # 检查关键集成点
            integration_checks = [
                ("统一新闻工具导入", "from trader.tools.news import create_unified_news_tool"),
        ...
        # 检查工作流程设置文件
        setup_file = "backend/trader/graph/setup.py"
        try:
            with open(setup_file, "r", encoding="utf-8") as f:
                setup_code = f.read()

            workflow_checks = [
                ("新闻分析师导入", "from trader.agents.analysts.news import create_news_analyst"),
