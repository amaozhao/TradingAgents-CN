...
def analyze_akshare_data():
    ...
    # 查找包含关键词的行
    pe_rows = main_indicators[
        main_indicators["指标"].str.contains("市盈率|PE", na=False, case=False)
    ]
    pb_rows = main_indicators[
        main_indicators["指标"].str.contains("市净率|PB", na=False, case=False)
    ]
    roe_rows = main_indicators[
        main_indicators["指标"].str.contains("净资产收益率|ROE", na=False, case=False)
    ]
    ...
    # 查找每股相关指标
    eps_rows = main_indicators[
        main_indicators["指标"].str.contains(
            "每股收益|每股净利润", na=False, case=False
        )
    ]
    ...
    # 查找每股净资产相关指标
    bps_rows = main_indicators[
        main_indicators["指标"].str.contains("每股净资产", na=False, case=False)
    ]
