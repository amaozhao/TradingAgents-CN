...
def test_connections():
    ...
    test_configs = [
        {
            "name": "Docker配置 (admin/trading_agents123)",
            "uri": "mongodb://admin:trading_agents123@localhost:27017/trading_agents?authSource=admin"
        },
        {
            "name": "之前导入时使用的配置",
            "uri": "mongodb://admin:admin123@localhost:27017/trading_agents?authSource=admin"
        },
        {
            "name": "无认证连接",
    ...
    for config in test_configs:
        ...
        try:
            ...
            # 如果有trading_agents数据库，列出集合
            if 'trading_agents' in dbs:
