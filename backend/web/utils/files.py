        ...
        try:
            ...
            debug_info = {
                ...
                "session_state_keys": [
                    ...
                    if "analysis" in k.lower() or "session" in k.lower()
                ],
            }
...
def get_persistent_analysis_id() -> Optional[str]:
    ...
    try:
        ...
        # 2. 检查文件会话数据
        session_data = files.load_analysis_state()
        if session_data:
            ...
            if analysis_id:
                ...
                st.session_state.session_fingerprint = session_data.get(
                    "fingerprint", ""
                )
