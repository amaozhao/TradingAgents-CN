...
class MongoDBReportManager:
    ...
    def _connect(self):
        ...
        try:
            ...
            mongodb_database = os.getenv("MONGODB_DATABASE", "trading_agents")
    ...
    def save_analysis_report(self, stock_symbol: str, analysis: Dict[str, Any],
        ...
        try:
            ...
            document = {
                ...
                "research_depth": analysis.get("research_depth", 1),  # 修正：从分析结果中获取真实的研究深度
