...
from web.utils.progress import get_progress_by_id, format_time
...
def create_progress(container, analysis_id: str, refresh_interval: float = 1.0) -> AsyncProgressDisplay:
    """创建异步进度显示组件"""
