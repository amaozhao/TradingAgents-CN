...
from tradingagents.utils.toollogging import log_tool_call, log_analysis_step
...
def build_instrument_context(
    ...
    from tradingagents.agents.utils.instrumentutils import build_instrument_context as _build
...
"""
    ...
    def get_china_fundamentals(
        ...
        try:
            ...
            # 调用真正的基本面分析
            from tradingagents.dataflows.optimizedchinadata import OptimizedChinaDataProvider
