...
from app.services.research_agent import goals as goals_module
...
from app.services.research_agent.goals import ResearchGoalConflictError, ResearchGoalService
