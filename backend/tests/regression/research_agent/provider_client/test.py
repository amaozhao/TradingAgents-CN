...
from app.services.research_agent import provider_client as provider_module
from app.services.research_agent.context import ResearchPrincipal
from app.services.research_agent.provider_client import (
    AgentModelConfigurationError,
    OpenAICompatibleModelClient,
)
from app.services.research_agent.registry import ResearchTool
        ...
        async for chunk in OpenAICompatibleModelClient(_principal()).stream(
            ...
            tools=[
                ResearchTool(
                    ...
                    permission="research.market_data.read",
                    schema={
                        "type": "object",
