...
import tradingagents.defaultconfig as default_config
from tradingagents.dataflows.dataflowsconfig import get_config, set_config
...
class DataflowsConfigIsolationTests(unittest.TestCase):
    ...
    def test_get_config_returns_deep_copy(self):
        ...
        fresh = get_config()
        self.assertEqual(fresh["data_vendors"]["core_stock_apis"], "cn_unified")
    ...
    def test_partial_nested_update_preserves_existing_defaults(self):
        ...
        fresh = get_config()
        self.assertEqual(fresh["data_vendors"]["core_stock_apis"], "alpha_vantage")
        self.assertEqual(fresh["data_vendors"]["technical_indicators"], "cn_unified")
        self.assertEqual(fresh["data_vendors"]["fundamental_data"], "cn_unified")
        self.assertEqual(fresh["data_vendors"]["news_data"], "cn_unified")
...
_export_module(globals(), "testsupport.testsxquicktest")
_export_module(globals(), "testsupport.testsxtestdataconfigcli")
_export_module(globals(), "testsupport.testsxtestopenaiconfigfix")
del _export_module
