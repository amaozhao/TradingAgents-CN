...
from tradingagents.dataflows.providers.tushareprovider import TushareProvider
...
class TestTushareProvider:
    ...
    async def test_connect_success(self, provider, mock_tushare_api):
        """测试连接成功"""
        with patch('tradingagents.dataflows.providers.tushareprovider.TUSHARE_AVAILABLE', True), \
             patch('tradingagents.dataflows.providers.tushareprovider.ts') as mock_ts, \
