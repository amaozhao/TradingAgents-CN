...
from tradingagents.llmclients.apikeyenv import PROVIDER_API_KEY_ENV, get_api_key_env
...
def cli_utils(monkeypatch):
    """Import cli.cliutils with a fresh environment so module-level state is consistent."""
    import importlib
    import cli.cliutils as cli_utils_module
