...
from tradingagents.graph.signalprocessing import SignalProcessor
...
_export_module(globals(), "testsupport.testsxtestchineseoutput")
_export_module(globals(), "testsupport.testsxtestsignalprocessordebug")
_export_module(globals(), "testsupport.testsxtestsignalprocessorfix")
del _export_module
