...
def test_market_analyst_hk_config():
    ...
    try:
        # 读取市场分析师文件
        with open('backend/tradingagents/agents/analysts/market_analyst.py', 'r', encoding='utf-8') as f:
            content = f.read()
...
def test_fundamentals_analyst_hk_config():
    ...
    try:
        # 读取基本面分析师文件
        with open('backend/tradingagents/agents/analysts/fundamentals_analyst.py', 'r', encoding='utf-8') as f:
            content = f.read()
