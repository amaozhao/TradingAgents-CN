...
from app.worker.tusharesyncservice import TushareSyncService
...
class TestTushareSyncService:
    ...
    def sync_service(self):
        ...
        with patch('app.worker.tusharesyncservice.get_mongo_db') as mock_get_db, \
             patch('app.worker.tusharesyncservice.get_stock_data_service') as mock_get_service:
