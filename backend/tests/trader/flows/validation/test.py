...
import trader.flows.validation as validator
...
class TestVerifiedSnapshot:
    ...
    def test_look_back_window_capped_at_30(self, monkeypatch):
        ...
        snap = validator.build_verified_market_snapshot(
            "COF", "2026-05-20", look_back_days=999
        )
...
class TestTool:
    def test_tool_delegates_to_builder(self, monkeypatch):
        get_verified_market_snapshot = getattr(
            importlib.import_module("trader.agents.utils.validation"),
