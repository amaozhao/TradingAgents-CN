...
def test_sanitize_real_export_file():
    """测试对真实导出文件的脱敏"""
    # 读取真实导出文件
    with open("backend/install/database_export_config_2025-10-25.json", "r", encoding="utf-8") as f:
    ...
    with open("backend/install/database_export_config_2025-10-25_SANITIZED.json", "w", encoding="utf-8") as f:
