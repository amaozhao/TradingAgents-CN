...
def main():
    ...
    try:
        ...
        print("\n🔗 相关文件:")
        files = [
            "backend/tradingagents/config/database_config.py - 统一配置管理",
            "backend/tradingagents/dataflows/stock_data_service.py - 股票数据服务",
            "backend/tradingagents/api/stock_api.py - 便捷API接口",
