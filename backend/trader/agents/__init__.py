...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "create_bear_researcher": (
        "trader.agents.researchers.bear",
        "create_bear_researcher",
    ),
    "create_bull_researcher": (
        "trader.agents.researchers.bull",
        "create_bull_researcher",
    ),
    "create_research_manager": (
        "trader.agents.managers.research",
        "create_research_manager",
    ),
    "create_portfolio_manager": (
        "trader.agents.managers.portfolio",
        "create_portfolio_manager",
    ),
    ...
    "create_social_media_analyst": (
        "trader.agents.analysts.social",
        "create_social_media_analyst",
    ),
    "create_sentiment_analyst": (
        "trader.agents.analysts.sentiment",
        "create_sentiment_analyst",
    ),
    "create_risky_debator": (
        "trader.agents.risk.management.risky",
        "create_risky_debator",
    ),
    "create_safe_debator": (
        "trader.agents.risk.management.conservative",
        "create_safe_debator",
    ),
    "create_neutral_debator": (
        "trader.agents.risk.management.neutral",
        "create_neutral_debator",
    ),
