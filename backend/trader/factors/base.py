...
# ---------------------------------------------------------------------------
# CN compatibility surface. The real Vibe factor zoo uses Alpha/compute(panel),
# while existing CN backend services expect FactorMetadata and calculate(panel).
# ---------------------------------------------------------------------------
...
class Factor(Protocol):
    """Executable factor contract used by CN compatibility callers."""
