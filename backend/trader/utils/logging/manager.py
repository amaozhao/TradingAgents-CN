...
_bootstrap_logger = logging.getLogger("trader.logging_manager")
...
class TradingAgentsLogger:
    ...
    def _add_error_handler(self, logger: logging.Logger):
        ...
        log_dir = Path(
            error_config.get("directory", self.config["handlers"]["file"]["directory"])
        )
    ...
    def _add_structured_handler(self, logger: logging.Logger):
        ...
        log_file = log_dir / "trading_agents_structured.log"
