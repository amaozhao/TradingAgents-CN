...
def test_stock_news():
    ...
    news_data = manager.get_news_data(
        symbol=test_symbol, hours_back=hours_back, limit=limit
    )
    print()
...
def test_different_time_ranges():
    ...
    for hours in time_ranges:
        ...
        news_data = manager.get_news_data(
            symbol=test_symbol, hours_back=hours, limit=10
        )
