...
使用方法：
    python scripts/ps/calculation/verification/test.py 600036
...
async def main():
    ...
    if len(sys.argv) < 2:
        print(
            "用法: python scripts/ps/calculation/verification/test.py <股票代码1> [股票代码2] ..."
        )
        print("\n示例:")
        print("  python scripts/ps/calculation/verification/test.py 600036")
        print(
            "  python scripts/ps/calculation/verification/test.py 000001 000002 600036"
        )
        sys.exit(1)
