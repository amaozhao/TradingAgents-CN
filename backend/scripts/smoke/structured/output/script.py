...
Usage:
    OPENAI_API_KEY=... python scripts/smoke/structured/output/script.py openai
    GOOGLE_API_KEY=... python scripts/smoke/structured/output/script.py google
    ANTHROPIC_API_KEY=... python scripts/smoke/structured/output/script.py anthropic
    DEEPSEEK_API_KEY=... python scripts/smoke/structured/output/script.py deepseek
