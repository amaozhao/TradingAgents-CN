...
def test_fundamentals_from_postgres():
    """测试从 PostgreSQL 获取基本面数据"""
    print("\n" + "=" * 70)
    print("🧪 测试从 PostgreSQL 获取基本面数据")
    print("=" * 70)
    ...
    if not manager.use_postgres_cache:
        print("\n⚠️ PostgreSQL 缓存未启用，跳过 PostgreSQL 测试")
        return
...
if __name__ == "__main__":
    try:
        ...
        # 测试从 PostgreSQL 获取
        test_fundamentals_from_postgres()
        ...
        print("\n💡 提示：检查上面的日志，确认:")
        print("   1. 基本面数据是否从 PostgreSQL 优先获取")
