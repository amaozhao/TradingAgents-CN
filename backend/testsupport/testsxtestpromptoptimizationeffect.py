...
def test_fundamentals_analyst_prompt():
    ...
    try:
        ...
        # 创建LLM和工具包
        from tradingagents.llmadapters import ChatDashScopeOpenAI
        ...
        # 创建基本面分析师
        from tradingagents.agents.analysts.fundamentalsanalyst import create_fundamentals_analyst
        ...
        for ticker, market_type, expected_name in test_cases:
            ...
            # 获取公司名称（验证提示词构建逻辑）
            from tradingagents.agents.analysts.fundamentalsanalyst import _get_company_name_for_fundamentals
...
def test_market_analyst_prompt():
    ...
    try:
        ...
        # 创建市场分析师
        from tradingagents.agents.analysts.marketanalyst import create_market_analyst
        ...
        # 获取公司名称（验证提示词构建逻辑）
        from tradingagents.agents.analysts.marketanalyst import _get_company_name
        from tradingagents.utils.stockutils import StockUtils
