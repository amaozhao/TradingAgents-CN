...
def test_openai_adapter_connection():
    ...
    try:
        from tradingagents.llmadapters.dashscopeopenaiadapter import test_dashscope_openai_connection
...
def test_openai_adapter_function_calling():
    ...
    try:
        from tradingagents.llmadapters.dashscopeopenaiadapter import test_dashscope_openai_function_calling
