...
def debug_config_manager():
    ...
    try:
        from tradingagents.config.configmanager import ConfigManager
...
def debug_token_tracker():
    ...
    try:
        from tradingagents.config.configmanager import ConfigManager, TokenTracker
...
def debug_deepseek_adapter():
    ...
    try:
        ...
        from tradingagents.llmadapters.deepseekadapter import TOKEN_TRACKING_ENABLED
