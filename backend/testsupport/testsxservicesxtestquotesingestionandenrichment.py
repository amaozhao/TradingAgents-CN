...
def test_enhanced_screening_enriches_from_db(monkeypatch):
    ...
    from app.services.enhancedscreeningservice import EnhancedScreeningService
    ...
    import app.services.enhancedscreeningservice as ess_mod
...
def test_quotes_ingestion_run_once_writes_bulk(monkeypatch):
    ...
    import app.services.quotesingestionservice as qis_mod
