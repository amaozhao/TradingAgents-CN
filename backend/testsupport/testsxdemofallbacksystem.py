...
def main():
    ...
    try:
        ...
        print("\n🔗 相关文件:")
        files = [
            "backend/tradingagents/config/databaseconfig.py - 统一配置管理",
            "backend/tradingagents/dataflows/dataflowstockservice.py - 股票数据服务",
            "backend/tradingagents/api/stockapiendpoint.py - 便捷API接口",
            "backend/examples/stock_query_examples.py - 使用示例",
