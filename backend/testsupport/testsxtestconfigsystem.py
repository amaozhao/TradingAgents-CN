...
from app.core.startupvalidator import (
    StartupValidator,
    ConfigItem,
    ConfigLevel,
    ValidationResult,
...
class TestConfigCompat:
    ...
    def test_config_manager_compat_creation(self):
        """测试配置管理器兼容层创建"""
        from app.core.coreconfigcompat import ConfigManagerCompat
    ...
    def test_token_tracker_compat_creation(self):
        """测试 Token 跟踪器兼容层创建"""
        from app.core.coreconfigcompat import TokenTrackerCompat
