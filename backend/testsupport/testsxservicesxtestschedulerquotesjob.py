...
def test_scheduler_adds_quotes_job(monkeypatch):
    ...
    # Fake QuotesIngestionService used by app.appmain during startup
    ...
    # Patch scheduler and service in app.appmain before startup runs
    import app.appmain as main_mod
