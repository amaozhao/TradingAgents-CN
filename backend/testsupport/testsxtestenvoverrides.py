...
import tradingagents.defaultconfig as default_config_module
...
def test_no_env_uses_built_in_defaults(monkeypatch):
    ...
    assert dc.DEFAULT_CONFIG["deep_think_llm"] == "o4-mini"
    assert dc.DEFAULT_CONFIG["quick_think_llm"] == "gpt-4o-mini"
    assert dc.DEFAULT_CONFIG["backend_url"] == "https://api.openai.com/v1"
