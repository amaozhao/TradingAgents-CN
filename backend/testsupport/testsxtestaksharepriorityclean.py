...
def clean_import_test():
    ...
    try:
        # 清理可能的模块缓存
        modules_to_clean = [
            'tradingagents.dataflows.datasourcemanager',
        ...
        # 重新导入
        from tradingagents.dataflows.datasourcemanager import DataSourceManager, ChinaDataSource
...
def test_fallback_order():
    ...
    try:
        ...
        # 清理并重新导入
        if 'tradingagents.dataflows.datasourcemanager' in sys.modules:
            del sys.modules['tradingagents.dataflows.datasourcemanager']
        
        from tradingagents.dataflows.datasourcemanager import DataSourceManager
