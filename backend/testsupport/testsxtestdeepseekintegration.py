...
def test_deepseek_adapter():
    ...
    try:
        from tradingagents.llm.deepseekadapter import DeepSeekAdapter, create_deepseek_adapter
...
def test_deepseek_connection():
    ...
    try:
        from tradingagents.llm.deepseekadapter import create_deepseek_adapter
