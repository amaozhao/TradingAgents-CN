...
try:
    from tradingagents.dataflows.dataflowstockservice import StockDataService, get_stock_data_service
...
class TestFallbackMechanism(unittest.TestCase):
    ...
    @patch('tradingagents.dataflows.dataflowstockservice.DATABASE_MANAGER_AVAILABLE', False)
