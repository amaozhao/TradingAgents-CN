...
def test_china_stock_data_sources():
    ...
    for symbol in test_symbols:
        ...
        try:
            print(f"🔍 测试优化版本...")
            from tradingagents.dataflows.optimizedchinadata import get_china_stock_data_cached
...
def test_news_data_sources():
    ...
    for symbol in test_symbols:
        ...
        try:
            print(f"🔍 测试实时新闻聚合器...")
            from tradingagents.dataflows.realtimenewsutils import RealtimeNewsAggregator
...
if __name__ == "__main__":
    ...
    print(f"\n📋 下一步:")
    print("1. 根据建议优化配置")
    print("2. 运行 python -m cli.climain 测试完整流程")
