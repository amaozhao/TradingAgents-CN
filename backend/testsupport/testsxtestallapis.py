...
def test_tradingagents_with_new_apis():
    ...
    try:
        ...
        # 检查Google相关工具
        try:
            from tradingagents.dataflows.googlenewsutils import get_google_news
        ...
        # 检查Reddit相关工具  
        try:
            from tradingagents.dataflows.dataflowreddit_utils import get_reddit_sentiment
...
def test_social_media_analyst():
    ...
    try:
        ...
        # 检查社交媒体分析师
        from tradingagents.agents.analysts.socialmediaanalyst import create_social_media_analyst
        from tradingagents.llmadapters import ChatDashScope
