...
from app.services.queueservice import QueueService, get_queue_service as real_get_queue_service
...
def test_sse_batch_connected_event(monkeypatch):
    ...
    import app.services.queueservice as qsvc_mod
...
def test_worker_intervals_env_and_dynamic_override(monkeypatch):
    ...
    import app.worker.analysisworker as analysis_worker
