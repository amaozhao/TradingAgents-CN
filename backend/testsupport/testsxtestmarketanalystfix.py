...
def test_deepseek_market_analyst():
    ...
    try:
        ...
        from tradingagents.llmadapters.deepseekadapter import ChatDeepSeek
...
def test_dashscope_market_analyst():
    ...
    try:
        ...
        from tradingagents.agents.analysts.marketanalyst import create_market_analyst_react
        from tradingagents.llmadapters.dashscopeadapter import ChatDashScope
        from tradingagents.agents.utils.agentutils import Toolkit
        from tradingagents.defaultconfig import DEFAULT_CONFIG
