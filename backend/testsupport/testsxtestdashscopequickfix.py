...
def test_vs_old_adapter():
    ...
    try:
        from tradingagents.llmadapters import ChatDashScope, ChatDashScopeOpenAI
...
def test_import_completeness():
    ...
    imports = [
        ("ChatDashScopeOpenAI", "tradingagents.llmadapters"),
        ("create_dashscope_openai_llm", "tradingagents.llmadapters.dashscopeopenaiadapter"),
        ("TradingAgentsGraph", "tradingagents.graph.graphtradinggraph"),
...
def main():
    ...
    if passed >= 5:  # 至少5个测试通过
        ...
        print("\n🚀 现在可以测试实际的技术面分析了！")
        print("   建议运行: python -m cli.climain")
