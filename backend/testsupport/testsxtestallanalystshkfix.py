...
def test_market_analyst_hk_config():
    ...
    try:
        # 读取市场分析师文件
        with open('backend/tradingagents/agents/analysts/marketanalyst.py', 'r', encoding='utf-8') as f:
            content = f.read()
...
def test_fundamentals_analyst_hk_config():
    ...
    try:
        # 读取基本面分析师文件
        with open('backend/tradingagents/agents/analysts/fundamentalsanalyst.py', 'r', encoding='utf-8') as f:
            content = f.read()
...
def test_optimized_us_data_hk_support():
    ...
    try:
        # 读取优化美股数据文件
        with open('backend/tradingagents/dataflows/optimized_us_data.py', 'r', encoding='utf-8') as f:
            content = f.read()
