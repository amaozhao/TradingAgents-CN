...
from scripts.postgres_local_cutover_verify import (
    LocalServices,
    StepResult,
    _safe_env_snapshot,
...
def test_local_cutover_env_snapshot_redacts_password_and_token():
    ...
    env["TRADINGAGENTS_API_BASE_URL"] = "http://127.0.0.1:18080"
    env["TRADINGAGENTS_API_TOKEN"] = "secret-token"

    snapshot = _safe_env_snapshot(env)

    assert snapshot["POSTGRES_PASSWORD_SET"] is True
    assert snapshot["TRADINGAGENTS_API_TOKEN_SET"] is True
