...
print("\n📁 检查复制的文件...")
files_to_check = [
    'backend/tradingagents/dataflows/cache_manager.py',
    'backend/tradingagents/dataflows/optimized_us_data.py',
    'backend/tradingagents/dataflows/dataflowsconfig.py'
]
...
# 测试配置模块
try:
    from tradingagents.dataflows.dataflowsconfig import get_config
    print("✅ config 导入成功")
