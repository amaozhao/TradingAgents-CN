...
async def test_sync_control_functions():
    ...
    try:
        from app.services.multisourcebasicssyncservice import get_multi_source_sync_service
...
async def test_api_endpoints():
    ...
    try:
        # 这里可以添加HTTP客户端测试
        # 但为了简化，我们直接调用路由函数
        from app.routers.multisourcesync import get_sync_status, clear_sync_cache, run_stock_basics_sync
