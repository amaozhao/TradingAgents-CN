...
def test_basics_prefers_app_cache_when_enabled(monkeypatch):
    ...
    import tradingagents.dataflows.dataflowstockservice as sds_mod
    monkeypatch.setattr(sds_mod, "ENHANCED_FETCHER_AVAILABLE", True, raising=False)

    from tradingagents.dataflows.dataflowstockservice import StockDataService
...
def test_realtime_quotes_prefers_app_market_quotes(monkeypatch):
    ...
    import tradingagents.dataflows.appcacheadapter as app_cache_adapter
    ...
    from tradingagents.dataflows.dataflowtushareadapter import TushareDataAdapter
