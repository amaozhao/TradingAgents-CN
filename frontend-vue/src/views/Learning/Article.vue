...
const registry: Record<string, ArticleInfo> = {
  ...
  'agentrader_intro': { title: 'AGENTrader架构介绍', loader: () => import('../../../../docs/learning/06-resources/agentrader_intro.md?raw'), category: '架构与论文', categoryType: 'primary', readTime: '15分钟' },
  'paper-guide': { title: 'AGENTrader论文解读', loader: () => import('../../../../docs/learning/06-resources/paper-guide.md?raw'), category: '架构与论文', categoryType: 'primary', readTime: '20分钟' },
  'AGENTrader_论文中文版': { title: 'AGENTrader 论文中文版', loader: () => import('../../../../docs/paper/AGENTrader_论文中文版.md?raw'), category: '架构与论文', categoryType: 'primary', readTime: '40分钟' },
